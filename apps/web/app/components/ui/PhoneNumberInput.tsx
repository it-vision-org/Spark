...
export function PhoneNumberInput({ formData, setFormData }: PhoneNumberInputProps) {
  return (
    <>
      {/* Phone Number */}
        ...
        <div className="relative flex">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none h-full py-[0.85rem] pl-3 pr-9 rounded-l-xl text-[0.9rem] bg-white transition-all duration-300 outline-none cursor-pointer font-medium"
              style={{
                border: '2px solid var(--color-primary-100)', /* Orange: #ffedd5 */
                borderRight: 'none',
                color: 'var(--color-neutral-700)', /* Orange: #44403c */
              }}
              onFocus={(e) => {
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              type="tel"
              inputMode="numeric"
              className="w-full py-[0.85rem] pl-10 pr-4 rounded-r-xl text-[0.95rem] bg-white transition-all duration-300 outline-none"
              style={{
                border: '2px solid var(--color-primary-100)', /* Orange: #ffedd5 */
                borderLeft: 'none',
                color: 'var(--color-neutral-900)', /* Orange: #292524 */
              }}
              placeholder={formData.countryCode === '+216' ? '__ ___ ___' : '(___) ___-____'}
              ...
              onFocus={(e) => {
                e.target.style.borderColor = 'var(--color-primary-400)'; /* Orange: #fb923c */
                e.target.style.boxShadow = '0 0 0 4px rgba(59, 130, 246, 0.1)'; /* Orange: rgba(251, 146, 60, 0.1) */
                const select = e.target.closest('.relative.flex')?.querySelector('select') as HTMLSelectElement;
                if (select) { 
